...
legend([f1,f2,f3],{'Non-dispersion curve, $H=0$','Zero-order, $x_2=0.12m, \varepsilon=0$', ...
    'First-order, $x_2=0.12m, \varepsilon=0.05$'},'Location','southeast', 'interpreter', 'latex', 'FontSize',10)
